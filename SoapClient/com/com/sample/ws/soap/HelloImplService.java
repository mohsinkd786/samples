 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://soap.ws.sample.com/", wsdlLocation = "http://localhost:9999/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://soap.ws.sample.com/", "HelloImplService");
    ...
    public Hello getHelloImplPort() {
        return super.getPort(new QName("http://soap.ws.sample.com/", "HelloImplPort"), Hello.class);
    }
    ...
    public Hello getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.ws.sample.com/", "HelloImplPort"), Hello.class, features);
    }
